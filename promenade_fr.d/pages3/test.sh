...
# sed -i 's/&agrave;/à/g' *.html
# sed -i 's/&eacute;/é/g' *.html
# sed -i 's/&ccedil;/ç/g' *.html
# sed -i 's/&ocirc;/ô/g' *.html
# sed -i 's/&iuml;/ï/g' *.html
# sed -i 's/&egrave;/è/g' *.html
# sed -i 's/&icirc;/î/g' *.html
...
# sed -i 's/<script src="script.js"><\/script>/<script src="..\/pages1\/script.js"><\/script>/g' *.html
